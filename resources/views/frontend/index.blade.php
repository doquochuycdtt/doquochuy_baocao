...
<head>
   ...
   <link rel="stylesheet" href="{{  asset('../public/dist/css/all.min.css') }}">
   <link rel="stylesheet" href="{{  asset('../public/dist/css/frontend.css') }}">
   <script src="{{  asset('../public/dist/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
</head>
